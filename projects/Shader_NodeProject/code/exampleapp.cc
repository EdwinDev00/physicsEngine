...
ExampleApp::Open()
{
	...
	if (this->window->Open())
	{
		...
		shader_ptr->GetShaderResource("..\\projects\\Shader_NodeProject\\code\\vertexSourceShader.glsl"
			, "..\\projects\\Shader_NodeProject\\code\\fragmentSourceShader.glsl");
		...
		shared->texture.LoadTexture("..\\projects\\Shader_NodeProject\\texture\\tile.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
		...
		// Send in texture to the program
		shared2->texture.LoadTexture("..\\projects\\Shader_NodeProject\\texture\\tile.png", GL_TEXTURE_2D, GL_TEXTURE0, GL_RGBA, GL_UNSIGNED_BYTE);
		// Set the value to the texture uniform
